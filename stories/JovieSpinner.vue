<template>
  <svg
    ...
    :class="{
      ...
      'text-indigo-600 dark:text-indigo-400': spinnerColor === 'indigo',
      'text-blue-600 dark:text-blue-400': spinnerColor === 'blue',
      'text-green-600 dark:text-green-400': spinnerColor === 'green',
      'text-yellow-600 dark:text-yellow-400': spinnerColor === 'yellow',
      'text-red-600 dark:text-red-400': spinnerColor === 'red',
      'text-purple-600 dark:text-purple-400': spinnerColor === 'purple',
      'text-pink-600 dark:text-pink-400': spinnerColor === 'pink',
      'text-orange-600 dark:text-orange-400': spinnerColor === 'orange',
      'text-teal-600 dark:text-teal-400': spinnerColor === 'teal',
      'text-cyan-600 dark:text-cyan-400': spinnerColor === 'cyan',
    }"
