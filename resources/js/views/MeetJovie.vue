  ...
  <body class="main py-16">
    <div
      ...
      <div class="mb-8 w-full pr-0 md:w-1/2 md:pr-4 lg:mb-0 lg:pr-0 xl:w-1/3">
        <h1
          class="pr-16 text-2xl font-bold text-slate-700 md:text-4xl lg:pr-0 xl:text-5xl">
          👋🏻 Meet Jovie
        </h1>
        <p
          class="mt-4 w-full pr-0 text-base leading-normal text-slate-500 lg:w-10/12 lg:pr-16 xl:w-96 xl:pr-0">
        ...
        <router-link to="careers"
          ><ButtonGroup class="mt-4" text="Join us"> </ButtonGroup
        ></router-link>
      </div>
      <div class="md:w-1/2">
        <div class="h-auto w-full justify-between sm:flex">
          <div class="relative hidden h-48 rounded sm:block md:h-64 lg:h-72">
            <img
              class="inset-0 h-full w-full rounded object-cover object-top sm:w-72 xl:object-center"
              :src="asset('img/External/timwhite.webp')"
              alt="Display Picture of Tim White"
              role="img" />
            <div class="absolute left-0 bottom-0 rounded-tr bg-white px-6 py-4">
              <h5 class="mb-2 text-base leading-none text-slate-800">Tim</h5>
              <p class="text-base font-semibold leading-none text-slate-600">
                Founder
              </p>
            </div>
          </div>
          <div
            ...
            <img
              ...
              role="img" />
            <div class="absolute left-0 bottom-0 rounded-tr bg-white px-6 py-4">
              <h5 class="mb-2 text-base leading-none text-slate-800">
                Mackenzie
              </h5>
              <p class="text-base font-semibold leading-none text-slate-600">
                Founder
        ...
        <div class="relative mt-6 hidden h-48 rounded sm:block md:h-64 lg:h-72">
          <img
            ...
            role="img" />
          <div class="absolute left-0 bottom-0 rounded-tr bg-white px-6 py-4">
            <h5 class="mb-2 text-base leading-none text-slate-800">Based in</h5>
            <p class="text-base font-semibold leading-none text-slate-600">
              Los Angeles
            </p>
          </div>
    ...
    <NewsletterSignup />
    <div
      class="flex flex-col items-center justify-center space-y-8 bg-slate-50 py-12 px-4 sm:py-24 md:space-y-12 md:px-6 xl:px-20 2xl:container 2xl:mx-auto">
      <div
        class="flex flex-col items-center justify-center space-y-2 md:space-y-4">
        <h1
          class="text-center text-xl font-bold leading-5 text-slate-700 md:text-2xl md:leading-8 lg:text-4xl lg:font-bold">
          Culture
        </h1>
        <!--  <p
          class="text-center text-base leading-5 text-slate-600 md:w-2/3 md:leading-6">
...
const features = [
  ...
  },
  {
    name: 'Best idea wins',
    description:
      'We check our ego at the door.  The best idea wins, no matter who it came from.',
    icon: ScaleIcon,
  },
  {
  ...
  },
  {
    name: 'Be concise',
    description:
      'We use simple & concise language to communicate our ideas internally & externally. Concise emails,concise code,concise lunch orders. We value simplicity & clarity.',
