                    ...
                    <div class="bg-white px-4 py-5 shadow sm:rounded-lg sm:px-6">
                        ...
                        'flex-1 whitespace-nowrap border-b-2 py-4 px-1 text-base font-medium',
                            ...
                            <TabPanels as="template">
                                ...
                                <TabPanel class="space-y-12 px-4 pt-10 pb-6">
                                    <CreatorMediaGroup>
                                        <CreatorMediaItem v-for="media in creator.overview_media"
                                                          :media="media"></CreatorMediaItem>
                                    </CreatorMediaGroup>
                                </TabPanel>
                                <TabPanel class="space-y-12 px-4 pt-10 pb-6">
                                    <CommentThread :comments="comments" @getComments="getComments"/>
                                    <CommentBox ref="commentBox" :loading="addingComment" @addComment="addComment"/>
                                </TabPanel>
                            </TabPanels>
                        </TabGroup>
                    </div>
...
export default {
    ...
    methods: {
        ...
        addComment(comment) {
            ...
            CreatorService.addComment(data).then(response => {
                response = response.data
                if (response.status) {
