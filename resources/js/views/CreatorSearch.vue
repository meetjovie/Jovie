<template>
  <div class="h-screen bg-gray-50 pt-20 pb-16 text-center lg:pt-32">
    <h1
      ...
      <span class="relative whitespace-nowrap text-blue-600">
        ...
        <span class="relative">fastest</span> </span
      >creator search.
    </h1>
    <p class="mx-auto mt-6 max-w-2xl text-lg tracking-tight text-slate-700">
      Save time and money by instantly surfacing the best content creators for
      your needs.
    </p>
    ...
    <div class="mt-36 lg:mt-44">
      ...
      <ul
        class="mt-8 flex items-center justify-center space-x-8 sm:flex-col sm:space-x-0 sm:space-y-10 xl:flex-row xl:space-y-0 xl:space-x-12">
        <li>
          <ul
            class="flex flex-col items-center space-y-8 sm:flex-row sm:space-y-0 sm:space-x-12">
            <li class="flex">Logo</li>
            <li class="flex">Logo</li>
            <li class="flex">Logo</li>
          </ul>
        </li>
