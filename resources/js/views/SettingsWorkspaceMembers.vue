<template>
  <div>
    <SectionHeader
      header="Members"
      subheader="Manage who has access to this workspace." />
    <SectionWrapper
      callToAction="Invite people"
      header="Manage members"
      @ctaClick="invitePeople()"
      ctaLink="/plan">
    ...
    <div class="mt-10 py-4">
     <!--  <div
        ...
        <div class="">
          ...
          <p class="max-w-2xl text-sm text-slate-500 dark:text-jovieDark-300">
            ...
            member/members to you current active team.
              ...
              <ButtonGroup   v-if="currentUser.isCurrentTeamOwner"
                @click="showBuySeats()"
                icon="PlusIcon"
                design="primary"
                class="mx-auto "
      ...
      <div class="mt-6 w-full divide-y">
        <dl class="w-full justify-between"></dl>
      </div>
    </div>
  </div>
