        ...
        searchFunction(helper) {
            ...
            if (helper) {
                ...
                if (this.currentTab == 0) {
                    helper.state.hierarchicalFacetsRefinements['all_to'] = [this.currentUser.id]
                    ...
                    helper.state.hierarchicalFacetsRefinements['selected_to'] = [this.currentUser.id]
                    helper.state.hierarchicalFacetsRefinements['rejected_to'] = []
                } else if (this.currentTab == 2) {
                    helper.state.hierarchicalFacetsRefinements['all_to'] = []
                    helper.state.hierarchicalFacetsRefinements['selected_to'] = []
                    helper.state.hierarchicalFacetsRefinements['rejected_to'] = [this.currentUser.id]
                }
        ...
        async addToSelected() {
            ...
            await this.$store.dispatch('moveCreator', params).then((response) => {
                ...
                if (response.status) {
                    ...
                    this.$refs.hitResults.items[this.selectedCreatorIndex].all_to.splice(this.$refs.hitResults.items[this.selectedCreatorIndex].all_to.indexOf(this.currentUser.id), 1)
                    this.$refs.hitResults.items[this.selectedCreatorIndex].rejected_to.splice(this.$refs.hitResults.items[this.selectedCreatorIndex].rejected_to.indexOf(this.currentUser.id), 1)
        ...
        async addToRejected() {
            ...
            await this.$store.dispatch('moveCreator', params).then((response) => {
                ...
                if (response.status) {
                    this.$refs.hitResults.items.splice(this.selectedCreatorIndex, 1)
                    this.$refs.hitResults.items[this.selectedCreatorIndex].all_to.splice(this.$refs.hitResults.items[this.selectedCreatorIndex].all_to.indexOf(this.currentUser.id), 1)
                    this.$refs.hitResults.items[this.selectedCreatorIndex].selected_to.splice(this.$refs.hitResults.items[this.selectedCreatorIndex].selected_to.indexOf(this.currentUser.id), 1)
