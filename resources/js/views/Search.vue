            ...
            <div class="mx-auto flex">
              ...
              <main class="flex-auto">
                ...
                <TabGroup :defaultIndex="0">
                  ...
                  <div
                    class="sticky top-0 min-w-full items-center divide-y divide-slate-200 overflow-y-scroll">
                    <div
                      class="sticky top-0 z-10 grid grid-cols-3 items-center justify-between bg-slate-50/90 backdrop-blur-2xl backdrop-saturate-150">
                      <div
                        scope="col"
                        class="hidden items-center px-2 py-1 text-center text-xs font-medium tracking-wider text-slate-500 lg:inline-flex">
                        <div class="grid grid-cols-2 items-center">
                          <button @click="searchopen = !searchopen">
                            <ChevronLeftIcon
                              v-if="searchopen"
                              class="ml-2 mt-0.5 h-5 w-5 text-slate-400 hover:text-indigo-700"
                              :class="{ 'text-indigo-700': searchopen }"
                              aria-hidden="true"></ChevronLeftIcon>
                            <FunnelIcon
                              v-if="searchopen == false"
                              class="mx-2 mt-0.5 h-5 w-5 text-slate-400 hover:text-indigo-700"></FunnelIcon>
                          </button>
                      ...
                      <div
                        ...
                        <div class="mx-auto inline-flex w-full items-center">
                          <MagnifyingGlassIcon
                            class="mr-1 mt-0.5 inline-flex h-7 w-7 text-slate-400"
                              ...
                              <div
                                ...
                                <div
                                  ...
                                  <span
                                    ...
                                    <kbd
                                      class="inline-flex items-center px-2 font-sans text-sm font-medium text-slate-400">
                                      <JovieSpinner />
                                    </kbd>
                                  </span>
                                </div>
                      ...
                      <div
                        class="justfy-right relative items-center px-6 py-3 text-right text-xs font-medium tracking-wider text-slate-500">
                        ...
                        <div
                          ...
                          <div class="justify-right inline-flex items-center">
                            <div class="">
                              <ais-stats>
                                <template v-slot="{ nbHits, processingTimeMS }">
                                  ...
                                  <br />
                                  <div
                                    class="inline-flex items-center text-2xs text-slate-400">
                                    <div class="group">
                                      <JovieTooltip text="Search speed" />

                                      <BoltIcon
                                        class="mr-1 h-3 w-3 text-slate-400 hover:text-indigo-400"></BoltIcon>
                                    </div>
                                    <span>
                            ...
                            <div class="">
                              <ChevronRightIcon
                                @click="toggleSidebar"
                                class="mx-2 mt-0.5 h-5 w-5 cursor-pointer text-slate-400 hover:text-indigo-700" />
                            </div>
                          </div>
                        </div>
                      </div>
                  ...
                  <ais-state-results>
                    <template v-slot="{ results: { hits } }">
                      <ais-infinite-hits
                        ...
                        <template v-slot:item="{ item, index }">
                          <div
                            ...
                            class="h-full divide-y divide-slate-200 bg-white">
                            <div
                              :class="{
                              ...
                              <div
                                ...
                                <div class="flex items-center">
                                  <div class="mr-2 h-24 w-24 flex-shrink-0">
                                    <div
                                      @click="toggleSidebar"
                                      class="rounded-full bg-slate-200 p-0.5">
                                      <img
                                  ...
                                  <div class="w-96">
                                    ...
                                    <div
                                      class="wrap -mt-1 h-8 text-2xs font-light text-slate-900">
                                    ...
                                    <div
                                      ...
                                      <div
                                        class="text-slate-5 mx-auto cursor-pointer justify-center text-center"
                                        :class="[
                                          {
                                            'opacity-10':
                              ...
                              <div
                                ...
                                <div
                                  class="W-28 mx-auto flex-grow px-6 py-1 text-sm text-slate-500">
                                  <star-rating
                                    class="w-20"
                                    :star-size="12"
                                    :increment="0.5"
                                    ...
                                    <Menu
                                      ...
                                      <div class="inline-flex space-x-2">
                                        <PlusIcon
                                          ...
                                          class="h-5 w-5 cursor-pointer text-slate-500 hover:text-indigo-500" />
                      ...
                      <div v-else class="mx-auto w-full items-center">
                        <div
                          class="mx-auto mt-24 max-w-xl items-center p-12 text-center text-sm font-bold text-slate-500">
                          <ChevronUpIcon
                            class="mx-auto h-24 w-24 text-slate-200"
                            aria-hidden="true" />
                  ...
                  <div
                    ...
                    <div class="mt-4 flex justify-between px-4">
                      <div class="group" @click="sidebarOpen = false">
                        <XMarkIcon
                          class="h-5 w-5 cursor-pointer text-slate-700 hover:text-slate-900 active:text-slate-400 group-active:text-indigo-700" />
                      </div>
                      <div class="mr-4 flex space-x-2 text-xs text-slate-400">
                        <HeartIcon
                          class="h-5 w-5 cursor-pointer hover:text-slate-500" />
                        <NoSymbolIcon
                          class="h-5 w-5 cursor-pointer hover:text-slate-500" />
                        <div class="fixed top-4 text-right">
                          <Menu
                            ...
                            <div>
                              <MenuButton
                                class="inline-flex w-full justify-center rounded-md text-sm font-medium text-slate-700 hover:text-slate-900 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white focus-visible:ring-opacity-75">
                                <EllipsisVerticalIcon
                                  class="-mr-24 h-5 w-5 text-slate-400 hover:text-slate-700"
                                  aria-hidden="true" />
                              </MenuButton>
                            </div>
                            ...
                            <transition
                              ...
                              <MenuItems
                                class="absolute -right-12 z-50 mt-2 w-40 origin-top-right divide-y divide-slate-100 rounded-md bg-white shadow-lg ring-1 ring-black ring-opacity-5 focus-visible:outline-none">
                                <div class="px-1 py-1">
                                  <MenuItem
                                    v-slot="{ active }"
                                    @click="addToCrm(selectedCreator.id)">
                    ...
                    <div class="grid grid-cols-5 py-2 px-4">
                      ...
                      <div class="col-span-1">
                        <div
                          class="mx-auto mt-6 inline-flex w-full items-center justify-center text-center text-slate-400">
                          <MapPinIcon
                            v-if="
                        ...
                        <div
                          class="mx-auto inline-flex w-full justify-center text-sm text-slate-400">
                          <div
                            class="mt-1 grid grid-cols-2 gap-4 border-slate-200 pt-1">
                            ...
                            <div class="text-center">
                              ...
                              <div class="text-[8px] text-slate-400">EF</div>
                            </div>
                            <div class="text-center">
                              <div class="text-sm font-bold text-slate-600">
                                $0.50
                              </div>
                              <div class="text-[8px] text-slate-400">CPE</div>
                            </div>
                            <div
                              class="mx-auto w-full flex-grow justify-center px-6 py-1 text-sm text-slate-500">
                              <star-rating
                                class="w-full"
                                :star-size="12"
                                :increment="0.5"
                    ...
                    <div
                      ...
                      <form class="mt-5 sm:flex sm:items-center">
                        <span
                          class="mr-4 mt-1 items-center text-sm font-bold text-slate-500"
                          >Contact options:
                        </span>
                        <div
