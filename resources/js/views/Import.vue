        ...
        <div class="mt-5 md:mt-0 md:col-span-2">
          <form class="space-y-6" action="#" method="POST">
            ...
            <div>
              ...
              <div class="mt-1">
                <textarea id="about" name="about" rows="3" class="shadow-sm focus:ring-indigo-500 focus:border-indigo-500 block w-full sm:text-sm border border-gray-300 rounded-md" placeholder="@username" />
              </div>
            ...
            <SwitchGroup as="div" class="flex items-center justify-between">
                ...
                <SwitchLabel as="span" class="text-sm font-medium text-gray-900" passive>Update social data</SwitchLabel>
