      ...
      <div class="mx-auto max-w-7xl px-4 pt-24 sm:px-6 lg:px-8">
        <div class="sm:align-center sm:flex sm:flex-col">
          ...
          <div
            ...
            <button
              type="button"
              class="relative w-1/2 whitespace-nowrap rounded-md border-gray-200 bg-white py-2 text-sm font-medium text-gray-900 shadow-sm focus:z-10 focus:outline-none focus:ring-2 focus:ring-indigo-500 sm:w-auto sm:px-8">
              Monthly billing
            </button>
            <button
              type="button"
...
const logos = [
  {
    name: 'Tuple',
    url: 'https://tailwindui.com/img/logos/tuple-logo-indigo-200.svg',
  },
  {
    name: 'Mirage',
    url: 'https://tailwindui.com/img/logos/mirage-logo-indigo-200.svg',
  },
  {
    name: 'StaticKit',
    url: 'https://tailwindui.com/img/logos/statickit-logo-indigo-200.svg',
  },
  {
    name: 'Transistor',
    url: 'https://tailwindui.com/img/logos/transistor-logo-indigo-200.svg',
  },
  {
    name: 'Workcation',
    url: 'https://tailwindui.com/img/logos/workcation-logo-indigo-200.svg',
  },
];
const faqs = [
  {
