                ...
                <div class="mx-auto px-4 sm:px-6 lg:px-8">
                    <div class="flex justify-between h-12">
                        <div class="flex">
                            ...
                            <div class="flex-shrink-0 flex text-white items-center">
                                <a href="/">
                                    <svg
                            ...
                            <div class="hidden md:ml-6 md:items-center md:space-x-4">
                                <!-- Current: "bg-neutral-900 text-white", Default: "text-neutral-300 hover:bg-neutral-700 hover:text-white" -->
                                <a href="/product"
                                   class="bg-neutral-900 text-white px-3 py-2 rounded-md text-xs font-medium"
                                   aria-current="page">Product</a>

                                <!--<a href="/pricing"
                                    class="text-neutral-300 hover:bg-neutral-700 hover:text-white px-3 py-2 rounded-md text-xs font-medium">Pricing</a>-->
                                ...
                                <div v-if="!$store.state.AuthState.loading">
                                            ...
                                            <a class:="justify-center px-2 max-auto" @click="demo">
                                                <router-link to='demo'
                                                    ...
                                                    <span>
                                                        ...
                                                        <svg xmlns="http://www.w3.org/2000/svg"
                                                             class="hidden group-hover:block ml-1 h-4 w-4" fill="none"
                                                             viewBox="0 0 24 24" stroke="currentColor">
                                                            <path stroke-linecap="round" stroke-linejoin="round"
                                    ...
                                    <div v-else>
                                        <router-link to="dashboard"
                                                     class="text-sm border-transparent group rounded-md w-32 px-2 py-1 inline-flex items-center font-medium text-neutral-400 hover:text-neutral-100">
                                            Dashboard
                                        </router-link>
                                    </div>
                                </div>
                        ...
                        <svg class="absolute right-full transform translate-y-1/4 translate-x-1/4 lg:translate-x-1/2"
                            ...
                            <defs class="text-indigo-700">
                                <pattern id="f210dbf6-a58d-4871-961e-36d5016a0f49" x="0" y="0" width="20" height="20"
                                    ...
                                    <rect x="0" y="0" width="4" height="4" class="text-gray-200 opacity-50"
                                          fill="currentColor"/>
                                </pattern>
                            </defs>
                            ...
                            <div class="mt-5 max-w-md mx-auto sm:flex sm:justify-center md:mt-8">
                                <div class="rounded-md ">
                                    <div class="mt-8 sm:w-full sm:max-w-md xl:mt-0 xl:ml-8">
                                        <form class="sm:flex">
                                            <label v-if="!$store.state.addedToWaitList" for="email-address"
                                                   class="sr-only">Email address</label>
                                            <input v-if="!$store.state.addedToWaitList" id="email-address"
                                                   v-model="waitListEmail" name="email-address" type="email"
                                                   autocomplete="email" required=""
                                                   class="w-full shadow-xl shadow-indigo-700/20 border-indigo-700/30 px-5 py-3 placeholder-gray-500 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-offset-indigo-700 focus-visible:ring-white rounded-md"
                ...
                <div
                    ...
                    <div class="py-8 items-center">
                        ...
                        <div
                            ...
                            Find <span
                            class="underline decoration-4 decoration-pink-600 text-neutral-900 px-1">female</span> <span
                            class="underline decoration-4 decoration-amber-600 ">micro-influencers</span> wearing <span
                            class="underline decoration-4 decoration-sky-600 text-neutral-900 px-1">sunglasses</span>
                        </div>
                    </div>
                </div>
            </Discovery>
