            ...
            <div id="wbars" class="relative h-auto" style="overflow: hidden auto;">
                <div class="relative py-6 px-8 my-0 mx-auto" style="border-radius: 3px 3px 0px 0px;">
                    <div class="relative pb-6 border-b border-neutral-300 border-dotted">
                        <h1 class="p-0 mx-0 mt-0 mb-1 text-lg not-italic leading-6 text-neutral-800 border-0" style="font-weight: normal;">
                            Privacy Policy of
                            <strong class="p-0 m-0 leading-none border-0" style="font-weight: bold; font-size: 100%;">Jovie</strong>
                        </h1>

                        <p class="p-0 m-0 text-xs not-italic leading-5 border-0" style="font-weight: normal;">
                            Jovie collects some Personal Data from its Users.
                        </p>
                        <br class="">
                        <p class="p-0 m-0 text-xs not-italic leading-5 border-0" style="font-weight: normal;">
                    ...
                    <div class="float-none pb-5 w-full border-t-0 border-b border-neutral-300 border-dotted clearfix">
                        <h2 id="owner_of_the_data" class="px-0 pt-5 pb-0 m-0 text-base not-italic leading-5 text-neutral-800 border-0" style="font-weight: bold;">
                            Owner and Data Controller
                        </h2>
                        <p class="px-0 pt-1 pb-0 m-0 text-xs not-italic leading-5 border-0" style="font-weight: normal;">
                            Jovie Inc <br class="">124 West 60th St <br class="">43G
                            <br class="">New York NY 10023
                        </p>
                        <p class="px-0 pt-3 pb-0 m-0 text-xs not-italic leading-5 border-0" style="font-weight: normal;">
                            <strong class="p-0 m-0 leading-none border-0" style="font-weight: bold; font-size: 128%;">Owner contact email:</strong>
                            support@Jovie.ai
                        </p>
                    </div>

                    <div class="float-none pb-5 w-full border-t-0 border-b border-neutral-300 border-dotted clearfix">
                        <h2 id="types_of_data" class="px-0 pt-5 pb-0 m-0 text-base not-italic leading-5 text-neutral-800 border-0" style="font-weight: bold;">
                            Types of Data collected
                        </h2>

                        <p class="px-0 pt-1 pb-0 m-0 text-xs not-italic leading-5 border-0" style="font-weight: normal;">
                            Among the types of Personal Data that Jovie.ai collects, by itself
                            or through third parties, there are: Tracker; Usage Data.
                        </p>
                        ...
                        <p class="px-0 pt-3 pb-0 m-0 text-xs not-italic leading-5 border-0" style="font-weight: normal;">
                            ...
                            collection.<br class="">Personal Data may be freely provided by
                            the User, or, in case of Usage Data, collected automatically when
                            using Jovie.ai.<br class="">Unless specified otherwise, all Data
                            requested by Jovie.ai is mandatory and failure to provide this Data
                            may make it impossible for Jovie.ai to provide its services. In
                            cases where Jovie.ai specifically states that some Data is not
                            mandatory, Users are free not to communicate this Data without
                            consequences to the availability or the functioning of the
                            Service.<br class="">Users who are uncertain about which Personal
                            Data is mandatory are welcome to contact the Owner.<br class="">Any use of Cookies – or of other tracking tools – by Jovie.ai or
                            by the owners of third-party services used by Jovie.ai serves the
                        ...
                        <p class="px-0 pt-3 pb-0 m-0 text-xs not-italic leading-5 border-0" style="font-weight: normal;">
                            ...
                            published or shared through Jovie.ai and confirm that they have the
                            third party's consent to provide the Data to the Owner.
                        </p>
                    </div>

                    <div class="float-none pb-5 w-full border-t-0 border-b border-neutral-300 border-dotted clearfix">
                        <h2 id="place_of_processing" class="px-0 pt-5 pb-0 m-0 text-base not-italic leading-5 text-neutral-800 border-0" style="font-weight: bold;">
                            Mode and place of processing the Data
                        </h2>
                        <h3 class="px-0 pt-6 pb-0 m-0 text-xs not-italic leading-5 text-neutral-800 border-0" style="font-weight: bold;">
                            Methods of processing
                        </h3>
                        <p class="p-0 m-0 text-xs not-italic leading-5 border-0" style="font-weight: normal;">
                            The Owner takes appropriate security measures to prevent
                            unauthorized access, disclosure, modification, or unauthorized
                            destruction of the Data.<br class="">The Data processing is
                            carried out using computers and/or IT enabled tools, following
                            ...
                            operation of Jovie.ai (administration, sales, marketing, legal,
                        ...
                        <ul class="px-0 pt-1 pb-0 m-0 not-italic leading-none border-0" style="font-weight: normal; font-size: 128%; list-style: disc;">
                            <li class="p-0 mt-px mr-0 mb-0 ml-8 text-xs not-italic leading-5 text-left border-0" style="font-weight: normal; list-style: disc;">
                        ...
                        <p class="px-0 pt-3 pb-0 m-0 text-xs not-italic leading-5 border-0" style="font-weight: normal;">
                            ...
                            security measures taken by the Owner to safeguard their Data.<br class=""><br class="">
                    ...
                    <div class="float-none pb-5 w-full border-t-0 border-b border-neutral-300 border-dotted clearfix">
                        <h2 id="use_collected_data" class="px-0 pt-5 pb-0 m-0 text-base not-italic leading-5 text-neutral-800 border-0" style="font-weight: bold;">
                    ...
                    <div class="float-none pb-5 w-full border-t-0 border-b border-neutral-300 border-dotted clearfix">
                        <h2 id="data_processing_detailed_info" class="px-0 pt-5 pb-0 m-0 text-base not-italic leading-5 text-neutral-800 border-0" style="font-weight: bold;">
                        ...
                        <ul class="p-0 mx-0 mt-5 mb-0 not-italic leading-none border-0 clearfix" style="font-weight: normal; font-size: 128%; list-style: none;">
                            <li class="float-left clear-left p-0 m-0 w-1/2 text-xs not-italic leading-5 text-left border-0" style="font-weight: normal; list-style: none;">
                                <div class="p-2 mr-4 mb-4 rounded-sm border border-neutral-500 border-solid shadow-xs" style="border-image: initial; list-style: outside none none;">
                                    <h3 class="relative px-0 pt-6 pb-0 m-0 not-italic text-neutral-800 border-0 cursor-pointer" style="font-weight: bold;">
                                        Interaction with external social networks and platforms
                                    </h3>
                                    <div class="hidden mt-2" style="list-style: outside none none;">
                                        <p class="px-0 pt-3 pb-0 m-0 not-italic border-0" style="font-weight: normal; list-style: outside none none;">
                                            This type of service allows interaction with social networks
                                            or other external platforms directly from the pages of
                                            Jovie.ai.<br class="" style="list-style: outside none none;">
                                            The interaction and information obtained through Jovie.ai
                                            are always subject to the User’s privacy settings for each
                                            social network.<br class="" style="list-style: outside none none;">
                                            This type of service might still collect traffic data for
                                            the pages where the service is installed, even when Users do
                                            not use it.<br class="" style="list-style: outside none none;">
                                            It is recommended to log out from the respective services in
                                            order to make sure that the processed data on Jovie.ai isn’t
                                            being connected back to the User’s profile.
                                        </p>

                                        <h4 class="px-0 pt-5 pb-0 m-0 not-italic border-0" style="font-weight: bold; list-style: outside none none;">
                                            Twitter Tweet button and social widgets (Twitter, Inc.)
                                        </h4>
                                        <div class="" style="list-style: outside none none;">
                                            <p class="inline-block px-0 pt-3 pb-0 m-0 not-italic border-0" style="font-weight: normal; list-style: outside none none;">
                                                The Twitter Tweet button and social widgets are services
                                                allowing interaction with the Twitter social network
                                        ...
                                        <p class="px-0 pt-3 pb-0 m-0 not-italic border-0" style="font-weight: normal; list-style: outside none none;">
                                            ...
                                            <a href="https://twitter.com/en/privacy" target="_blank" rel="noopener noreferrer" class="p-0 m-0 not-italic text-neutral-800 no-underline border-t-0 border-r-0 border-l-0 border-b border-neutral-200 border-solid cursor-pointer hover:border-neutral-400 hover:text-neutral-900" style="border-width: 0px; font-weight: normal; font-size: 128%; list-style: outside none none;">Privacy Policy</a>.
                                        </p>
                                    </div>
                                </div>
                            </li>
                    ...
                    <div class="float-none pb-5 w-full border-t-0 border-b border-neutral-300 border-dotted clearfix">
                        <h2 id="rights_subjects" class="px-0 pt-5 pb-0 m-0 text-base not-italic leading-5 text-neutral-800 border-0" style="font-weight: bold;">
                            The rights of Users
                        </h2>
                        <p class="px-0 pt-1 pb-0 m-0 text-xs not-italic leading-5 border-0" style="font-weight: normal;">
                        ...
                        <ul class="px-0 pt-1 pb-0 m-0 not-italic leading-none border-0" style="font-weight: normal; font-size: 128%; list-style: disc;">
                            <li class="p-0 mt-px mr-0 mb-0 ml-8 text-xs not-italic leading-5 text-left border-0" style="font-weight: normal; list-style: disc;">
                                <strong class="p-0 m-0 border-0" style="font-weight: bold; font-size: 128%;">Withdraw their consent at any time.</strong>
                            ...
                            <li class="p-0 mt-px mr-0 mb-0 ml-8 text-xs not-italic leading-5 text-left border-0" style="font-weight: normal; list-style: disc;">
                                <strong class="p-0 m-0 border-0" style="font-weight: bold; font-size: 128%;">Object to processing of their Data.</strong>
                            ...
                            <li class="p-0 mt-px mr-0 mb-0 ml-8 text-xs not-italic leading-5 text-left border-0" style="font-weight: normal; list-style: disc;">
                                <strong class="p-0 m-0 border-0" style="font-weight: bold; font-size: 128%;">Access their Data.</strong>
                            ...
                            <li class="p-0 mt-px mr-0 mb-0 ml-8 text-xs not-italic leading-5 text-left border-0" style="font-weight: normal; list-style: disc;">
                                <strong class="p-0 m-0 border-0" style="font-weight: bold; font-size: 128%;">Verify and seek rectification.</strong>
                                Users have the right to verify the accuracy of their Data and ask
                                for it to be updated or corrected.
                            </li>
                            <li class="p-0 mt-px mr-0 mb-0 ml-8 text-xs not-italic leading-5 text-left border-0" style="font-weight: normal; list-style: disc;">
                                <strong class="p-0 m-0 border-0" style="font-weight: bold; font-size: 128%;">Restrict the processing of their Data.</strong>
                            ...
                            <li class="p-0 mt-px mr-0 mb-0 ml-8 text-xs not-italic leading-5 text-left border-0" style="font-weight: normal; list-style: disc;">
                                <strong class="p-0 m-0 border-0" style="font-weight: bold; font-size: 128%;">Have their Personal Data deleted or otherwise removed.</strong>
                                Users have the right, under certain circumstances, to obtain the
                                erasure of their Data from the Owner.
                            </li>
                            <li class="p-0 mt-px mr-0 mb-0 ml-8 text-xs not-italic leading-5 text-left border-0" style="font-weight: normal; list-style: disc;">
                                <strong class="p-0 m-0 border-0" style="font-weight: bold; font-size: 128%;">Receive their Data and have it transferred to another
                                    controller.</strong>
                            ...
                            <li class="p-0 mt-px mr-0 mb-0 ml-8 text-xs not-italic leading-5 text-left border-0" style="font-weight: normal; list-style: disc;">
                                <strong class="p-0 m-0 border-0" style="font-weight: bold; font-size: 128%;">Lodge a complaint.</strong>
                    ...
                    <div class="float-none pb-5 w-full border-t-0 border-b border-neutral-300 border-dotted clearfix">
                        <h2 id="further_data_processing_info" class="px-0 pt-5 pb-0 m-0 text-base not-italic leading-5 text-neutral-800 border-0" style="font-weight: bold;">
                        ...
                        <p class="p-0 m-0 text-xs not-italic leading-5 border-0" style="font-weight: normal;">
                            ...
                            from improper use of Jovie.ai or the related Services.<br class="">The User declares to be aware that the Owner may be required to
                        ...
                        <p class="p-0 m-0 text-xs not-italic leading-5 border-0" style="font-weight: normal;">
                            ...
                            Jovie.ai may provide the User with additional and contextual
                        ...
                        <p class="p-0 m-0 text-xs not-italic leading-5 border-0" style="font-weight: normal;">
                            For operation and maintenance purposes, Jovie.ai and any third-party
                            services may collect files that record interaction with Jovie.ai
                            (System logs) use other Personal Data (such as the IP Address) for
                            this purpose.
                        </p>
                        <h3 class="px-0 pt-6 pb-0 m-0 text-xs not-italic leading-5 text-neutral-800 border-0" style="font-weight: bold;">
                        ...
                        <p class="p-0 m-0 text-xs not-italic leading-5 border-0" style="font-weight: normal;">
                            Jovie.ai does not support “Do Not Track” requests.<br class="">To
                        ...
                        <p class="p-0 m-0 text-xs not-italic leading-5 border-0" style="font-weight: normal;">
                            ...
                            Jovie.ai and/or - as far as technically and legally feasible -
                    ...
                    <div class="float-none pb-5 w-full border-t-0 border-b border-neutral-300 border-dotted clearfix">
                        <div class="p-2 mt-5 mb-4 leading-4 text-neutral-700 bg-white rounded-sm border border-neutral-500 border-solid shadow-xs" style="border-image: initial;">
                            <h3 id="definitions_and_legal_references" class="relative px-0 pt-6 pb-0 m-0 text-xs not-italic leading-5 text-neutral-800 border-0 cursor-pointer" style="font-weight: bold;">
                                Definitions and legal references
                            </h3>
                            <div class="px-1 mt-2 text-neutral-700" style="">
                                <h4 class="p-0 m-0 text-xs not-italic leading-none border-0" style="font-weight: bold;">
                                ...
                                <h4 class="px-0 pt-5 pb-0 m-0 text-xs not-italic leading-none border-0" style="font-weight: bold;">
                                    Usage Data
                                </h4>
                                <p class="px-0 pt-3 pb-0 m-0 text-xs not-italic leading-5 border-0" style="font-weight: normal;">
                                    Information collected automatically through Jovie.ai (or third-party
                                    services employed in Jovie.ai), which can include: the IP addresses or
                                    domain names of the computers utilized by the Users who use Jovie.ai, the
                                    ...
                                    within the Application) and the details about the path followed within the
                                ...
                                <p class="px-0 pt-3 pb-0 m-0 text-xs not-italic leading-5 border-0" style="font-weight: normal;">
                                    The individual using Jovie.ai who, unless otherwise specified, coincides
                                ...
                                <p class="px-0 pt-3 pb-0 m-0 text-xs not-italic leading-5 border-0" style="font-weight: normal;">
                                    ...
                                    the operation and use of Jovie.ai. The Data Controller, unless otherwise
                                    specified, is the Owner of Jovie.ai.
                                </p>

                                <h4 class="px-0 pt-5 pb-0 m-0 text-xs not-italic leading-none border-0" style="font-weight: bold;">
                                    Jovie.ai (or this Application)
                                </h4>
                                <p class="px-0 pt-3 pb-0 m-0 text-xs not-italic leading-5 border-0" style="font-weight: normal;">
                                ...
                                <p class="px-0 pt-3 pb-0 m-0 text-xs not-italic leading-5 border-0" style="font-weight: normal;">
                                    The service provided by Jovie.ai as described in the relative terms (if
                                ...
                                <hr class="pt-4 mx-0 mt-0 mb-4 border-t-0 border-r-0 border-l-0 border-b border-neutral-200 border-solid" style="border-width: 0px 0px 1px; border-image: initial;">
                                <h4 class="px-0 pt-5 pb-0 m-0 text-xs not-italic leading-none border-0" style="font-weight: bold;">
                                    Legal information
                                </h4>
                                <p class="px-0 pt-3 pb-0 m-0 text-xs not-italic leading-5 border-0" style="font-weight: normal;">
                                ...
                                <p class="px-0 pt-3 pb-0 m-0 text-xs not-italic leading-5 border-0" style="font-weight: normal;">
                                    This privacy policy relates solely to Jovie.ai, if not stated otherwise
                    ...
                    <div class="clear-both relative py-6 px-0" style="font-size: 11px;">
                        <p class="p-0 m-0 not-italic leading-5 border-0" style="font-weight: normal; font-size: 11px;">
                            Latest update: January 31, 2022
                        </p>

                        <p class="clear-both p-0 my-2 mx-0 not-italic leading-5 border-0" style="font-weight: normal; font-size: 11px;">
