<template>
  <div
    class="relative isolate z-0 mx-auto cursor-pointer items-center hover:opacity-100 dark:text-slate-300"
    :class="[
    ...
    <Float portal placement="bottom">
      <a class="" :href="link" target="blank">
        ...
        <svg
          ...
          :class="
            iconstyle == 'horizontal'
              ? 'z-0 mx-auto  '
              : 'mx-auto  text-slate-400 dark:text-slate-600'
          "
          v-if="icon == 'twitch'">
          <title>Twitch</title>
        ...
        <div
          class="text-center text-2xs text-slate-500 dark:text-slate-300"
          v-if="countsVisible">
          {{ followers }} || -
        </div>
      </a>
