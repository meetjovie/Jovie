    ...
    <!--  <Popover v-slot="{ open }" class="w-full">
      <Float placement="bottom-start" portal shift>
        ...
        <div v-if="open">
          <PopoverPanel
            static
            class="text-50 w-40 items-center rounded-md bg-slate-700 shadow-md">
            <div
              @click="$emit('hide-column')"
              class="flex cursor-pointer py-2 px-2 text-xs font-medium text-white first:rounded-t-md last:rounded-b-md hover:bg-slate-600"
