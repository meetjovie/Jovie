  ...
  <Menu v-slot="{ open }" as="div">
    <Float portal :offset="8" shift placement="right-end">
      ...
      <TransitionRoot
        ...
        <MenuItems
          as="div"
          class="w-24 origin-bottom-left divide-y divide-gray-100 rounded-md border-slate-300 bg-white/60 shadow-lg ring-1 ring-black ring-opacity-5 backdrop-blur-2xl backdrop-saturate-150 focus:outline-none dark:divide-gray-800 dark:border-jovieDark-border dark:bg-jovieDark-900/60">
          <div class="px-1 py-1">
            <MenuItem v-slot="{ active }" as="div">
              <div
                ...
                :class="[
                  active
                    ? 'bg-slate-300 text-slate-800 dark:bg-jovieDark-700 dark:text-jovieDark-100'
                    : ' text-slate-600  dark:text-jovieDark-400',
