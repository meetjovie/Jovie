    ...
    <div
      ...
      <div class="mt-2 2xl:mt-8">
        <fieldset class="mt-0 2xl:mt-2">
          ...
          <div
            ...
            <div
              class="flex cursor-pointer items-center justify-center rounded-md border py-3 px-3 text-sm font-medium uppercase opacity-50 hover:bg-slate-100 hover:opacity-100 focus-visible:outline-none sm:flex-1">
              <a :href="link.url">
                ...
                <div class="mt-3 relative rounded-md">
                    ...
                    <div class="flex items-center text-center">
                        ...
                        <input type="text" name="email" id="email"
                               class="mt-4 focus-visible:ring-indigo-500 py-3 focus-visible:border-indigo-500 block w-full pl-10 sm:text-sm border-slate-300 rounded-md"
      ...
      <a :href="profile.ctalink">
        <button
          ...
          <component :is="profile.icon" class="text-white" />
          {{ profile.ctatext }}
        </button>
      </a>
