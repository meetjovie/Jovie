        ...
        <div class="grid grid-cols-2">
          <div class="relative mt-1">
            <div
              ...
              <ArrowDownIcon class="h-5 w-5 text-slate-400" />
            </div>
            <input
              class="block w-full rounded-tl-md border-slate-200 py-2 pl-10 text-sm text-slate-500 focus-visible:border-indigo-500 focus-visible:ring-indigo-500"
              type="number"
              :min="0"
              :max="100"
              :placeholder="0"
          ...
          <div class="relative mt-1">
            <div
              class="pointer-events-none absolute inset-y-0 left-0 flex items-center pl-3">
              <ArrowUpIcon class="h-5 w-5 text-slate-400" />
            </div>
            <input
              class="block w-full rounded-tr-md border-slate-200 py-2 pl-10 text-sm text-slate-700 focus-visible:border-indigo-500 focus-visible:ring-indigo-500"
              type="number"
              :min="0"
              :max="100"
              :placeholder="100"
