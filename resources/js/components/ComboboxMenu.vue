<template>
  <Combobox as="div" class="h-60" v-model="selectedItem">
    <ComboboxInput
      @focusin="open = true"
      @focusout="query = ''"
      class="w-full rounded-md border border-slate-200 py-2 pl-3 pr-10 text-sm leading-5 text-gray-900 focus-visible:ring-0 dark:border-jovieDark-border dark:bg-jovieDark-800 dark:text-jovieDark-200"
    ...
    <div
      ...
      <ComboboxOptions static class="h-full">
        <div
          ...
          class="relative h-full cursor-default select-none items-center px-4 py-2 text-slate-700 dark:text-jovieDark-300">
          Nothing found.
        </div>
        <ComboboxOption
