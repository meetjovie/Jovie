      ...
      <TransitionRoot
        ...
        <MenuItems
          ...
          <div v-if="searchable" class="sticky top-0 px-1">
            <MenuItem
              as="div"
              class="border border-slate-200 bg-white/60 backdrop-blur-2xl backdrop-saturate-150 dark:border-jovieDark-700 dark:bg-jovieDark-900/60">
              <div class="relative flex items-center">
                ...
                <!-- <div
                  ...
                  <kbd
                    class="inline-flex items-center rounded border border-slate-200 px-1 font-sans text-2xs font-medium text-slate-400 dark:border-jovieDark-700"
                    >{{ item.shortcut }}</kbd
                  >
                </div> -->
              </div>
          ...
          <div
            class="overflow-y-scroll border-t border-slate-200 px-2 dark:bg-jovieDark-700">
            <div v-if="items">
                ...
                <MenuItem
                  ...
                  <router-link :to="item.route">
                    <div
                      ...
                      :class="{
                        'bg-slate-200 text-slate-700 dark:bg-jovieDark-600 dark:text-slate-100':
                          active,
                      }">
              ...
              <MenuItem
                ...
                @click="searchQuery = ''"
                class="group mt-1 flex w-full cursor-pointer items-center border-t border-slate-200 px-2 py-1 text-xs text-slate-600 hover:text-slate-600 dark:border-jovieDark-700 dark:text-slate-200">
