    ...
    <ul v-if="showMenu" class="">
      <div v-for="item in menuItems" :key="item.id">
        <div
          ...
          <div
            class="group w-6 flex-none cursor-grab items-center hover:bg-neutral-200">
            <MenuIcon
              class="h-4 w-4 text-gray-400/0 group-hover:text-gray-400"></MenuIcon>
          </div>

          <div class="flex w-full">
            <div class="rounded-md p-1 text-xs hover:bg-gray-400">
              {{ item.emoji || '😆' }}
            </div>
            <div>
              <span
          ...
          <div
            class="w-6 flex-none rounded-md p-1 hover:bg-gray-500 hover:text-gray-50">
            <span
