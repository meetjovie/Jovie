<template>
  <div
    ...
    class="flex-col text-neutral-400"
    :class="[{ 'opacity-10': !creator.instagram_handler }, 'opacity-100']">
    <div>
      <a
        :href="'https://instagram.com/' + creator.instagram_handler"
        target="blank">
        <svg
    ...
    <div class="text-center text-2xs text-neutral-500">
  ...
  <div
    ...
    :class="[{ 'opacity-10': !creator.tiktok_handler }, 'opacity-100']">
