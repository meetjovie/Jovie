<template>
  <TransitionRoot :show="open" as="template" @after-leave="query = ''" appear>
    <Dialog as="template" class="relative z-10" @close="open = false">
      <TransitionChild
        as="template"
      ...
      <div class="fixed inset-0 z-10 overflow-y-auto p-4 sm:p-6 md:p-20">
        <TransitionChild
          ...
          <DialogPanel
            class="mx-auto max-w-2xl transform divide-y divide-slate-500 divide-opacity-10 overflow-hidden rounded-xl bg-white bg-opacity-80 shadow-2xl ring-1 ring-black ring-opacity-5 backdrop-blur backdrop-filter transition-all">
                    ...
                    <ComboboxOption
                      ...
                      <li
                        :class="[
                          ...
                          active && 'bg-slate-900 bg-opacity-5 text-slate-900',
                        ]">
                        <FolderIcon
                          :class="[
                            'h-6 w-6 flex-none text-slate-900 text-opacity-40',
                        ...
                        <span
                          v-if="active"
                          class="ml-3 flex-none text-slate-500"
                          >Jump to...</span
                        >
                      </li>
                    </ComboboxOption>
                  ...
                  <ul class="text-sm text-slate-700">
                    <ComboboxOption
                      ...
                      <li
                        ...
                        <span
                          class="ml-3 flex-none text-xs font-semibold text-slate-500">
