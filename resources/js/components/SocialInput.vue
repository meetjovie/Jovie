<template>
  <div v-if="minimalDesign">
    <div class="relative rounded-md px-2 py-1 shadow-sm">
      <div
        ...
        <UserIcon
          v-else
          class="h-5 w-5 text-slate-600 dark:text-jovieDark-400" />
      </div>
      <input
  ...
  <div v-else>
    ...
    <div
      class="flex justify-between px-2 text-xs text-slate-400 dark:text-jovieDark-200">
      <div>
        Supports:
        <div class="inline-flex space-x-2">
          <SocialIcons
            ...
            width="10px"
            link="#"
            class="text-slate-400 dark:text-jovieDark-200"
            icon="twitch" />
          <SocialIcons
            height="10px"
            width="10px"
