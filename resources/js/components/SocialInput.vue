    ...
    <div class="relative rounded-md px-2 py-1 shadow-sm">
      <div
        ...
        <SocialIcons
          ...
          link="#"
          width="12" />
        <UserIcon v-else class="h-5 w-5 text-slate-600" />
      </div>
      <input
        ...
        tabindex="1"
        class="block w-full rounded-md border-slate-300 px-1 py-1 pl-8 text-2xs focus-visible:border-indigo-500 focus-visible:ring-indigo-500"
      ...
      <div class="group/exit absolute inset-y-0 right-0 flex items-center pr-3">
        ...
        <!-- <MagnifyingGlassIcon
          ...
          class="h-4 w-4 cursor-pointer text-slate-400 hover:text-slate-700" /> -->
        <XMarkIcon
          @click="cancelEdit()"
          class="h-4 w-4 cursor-pointer text-slate-400 hover:text-slate-700"
          aria-hidden="true" />
    ...
    <div>
      ...
      <div class="relative mt-1 rounded-md shadow-sm">
        ...
        <input
          ...
          v-on:keyup.enter="add()"
          tabindex="1"
          class="block w-full rounded-md border-2 border-indigo-300 py-3 pl-10 outline-indigo-200 placeholder:font-semibold placeholder:text-slate-400 focus-visible:border-indigo-400 focus-visible:outline-none focus-visible:ring-indigo-500 active:border-indigo-500 sm:text-sm"
    ...
    <div class="flex justify-between px-2 text-xs text-slate-400">
      ...
      <div class="flex items-center">
        <router-link class="group items-center" to="Import"
          ><CloudArrowUpIcon
            class="mr-1 inline-flex h-3 w-3 items-center text-slate-400 group-hover:text-slate-500"></CloudArrowUpIcon
