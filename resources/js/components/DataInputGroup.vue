    ...
    <div class="group relative mt-1 w-full">
      <div class="relative">
        ...
        <input
          ...
          class="input-field disable:cursor-none h-8 w-full rounded border border-slate-300 border-opacity-0 px-2 py-2 leading-none text-slate-700 placeholder-transparent outline-none transition focus-visible:border-indigo-500 group-hover:border-opacity-100 group-hover:bg-slate-50 dark:border-jovieDark-border/0 dark:bg-jovieDark-900 dark:text-jovieDark-100 dark:hover:bg-jovieDark-800 dark:focus-visible:border-indigo-400 dark:group-hover:border-jovieDark-border dark:group-hover:bg-jovieDark-800"
          :class="[
            icon ? 'pl-4' : '',
        ...
        <label
          ...
          :for="name"
          :id="id"
          class="peer-focus-visible:text-[8px]] absolute -top-2.5 left-0 ml-2 block cursor-text rounded-t-md border-t border-transparent bg-white px-1 pl-5 text-xs font-medium capitalize text-slate-400 transition-all group-hover:bg-slate-50 group-hover:text-slate-500 peer-placeholder-shown:top-1.5 peer-placeholder-shown:text-sm peer-placeholder-shown:font-medium peer-placeholder-shown:text-slate-400 peer-focus-visible:-top-2 peer-focus-visible:left-0 peer-focus-visible:font-medium dark:bg-jovieDark-900 dark:text-jovieDark-200 dark:hover:bg-jovieDark-800 group-hover:dark:border-jovieDark-border dark:group-hover:bg-jovieDark-800 dark:group-hover:text-slate-200 dark:peer-placeholder-shown:text-slate-200"
          >{{ label }}</label
        >
      </div>
