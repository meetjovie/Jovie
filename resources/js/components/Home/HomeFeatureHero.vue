    ...
    <div class="py-12">
      <div class="mx-auto max-w-7xl px-4 text-center sm:px-6 lg:px-8">
        ...
        <div class="mx-auto grid grid-cols-3 items-center py-8">
          <div
            class="mx-auto grid grid-cols-4 items-center justify-center gap-4">
            <div
              class="m-2 mx-auto h-10 w-10 rounded-lg border-2 p-2 text-neutral-400 shadow-md">
              <svg
                role="img"
                viewBox="0 0 24 24"
          ...
          <div>
            ...
            <div
              class="bg-igray-50 mx-auto -mt-14 h-40 w-40 animate-pulse items-center rounded-full border-4 border-neutral-200 bg-gradient-to-r from-neutral-50 p-8 shadow-2xl shadow-indigo-500/30"></div>
          </div>
          <div
            class="rounded-lg border-2 border-neutral-200 py-2 px-4 shadow-md">
            <div class="min-h-full w-full px-2 py-2">
              ...
              <div class="grid grid-cols-3">
                <div class="">
                  <img
                    class="h-18 w-18 aspect-square rounded-full border-4 border-neutral-200 object-cover object-center"
              ...
              <div class="grid grid-cols-6 py-2 px-4">
                <div class="text-neutral-400">
                  <svg
                    class="mx-auto h-4 w-4 text-neutral-500"
                    role="img"
                    viewBox="0 0 24 24"
                    xmlns="http://www.w3.org/2000/svg">
                    <title>Instagram</title>
