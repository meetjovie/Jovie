        ...
        <transition
          ...
          <PopoverPanel
            ...
            <div
              ...
              <div
                class="flex cursor-pointer items-center justify-between px-4 py-1 text-xs text-gray-700 first:pt-2 last:pb-2 even:border-2 even:border-b hover:bg-indigo-700 hover:text-white"
                href="#">
                ...
                <div
                  ...
                  :key="child"
                  class="absolute left-64 hidden w-60 items-center justify-between rounded-r-md bg-white/70 px-4 py-2 text-xs text-gray-700 backdrop-blur-xl backdrop-saturate-150 backdrop-filter first:pt-2 hover:bg-indigo-700 hover:text-white group-hover:flex">
                  <div class="inline-flex items-center">
                    <Component
                      :is="child.icon"
