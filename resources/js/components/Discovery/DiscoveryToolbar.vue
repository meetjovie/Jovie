        ...
        <div>
            <TabGroup @change="$emit('changeTab', $event)">
                <TabList>
                    ...
                    ><span :class="[
            selected
              ? 'relative inline-flex cursor-pointer items-center rounded-l-md border px-4 py-1 text-xs font-medium hover:bg-gray-50 focus-visible:z-10 focus-visible:border-indigo-500 focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-indigo-500 active:bg-indigo-700 active:bg-indigo-700 active:text-white active:text-white bg-indigo-700 text-white'
