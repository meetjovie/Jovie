              ...
              <div class="grid grid-cols-6 gap-6">
                <div class="col-span-6 sm:col-span-4">
                  ...
                  <button
                    ...
                    type="button"
                    class="mt-2 mr-2 inline-flex items-center rounded-md border border-slate-300 bg-white px-4 py-2 text-xs font-semibold uppercase tracking-widest text-slate-700 shadow-sm transition hover:text-slate-500 focus-visible:border-blue-300 focus-visible:outline-none focus-visible:ring focus-visible:ring-blue-200 active:bg-slate-50 active:text-slate-800 disabled:opacity-25 dark:border-jovieDark-700 dark:border-jovieDark-700 dark:bg-jovieDark-800 dark:bg-jovieDark-900 dark:text-slate-200">
                    Remove Photo
                  </button>
                </div>
