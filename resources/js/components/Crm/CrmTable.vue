    ...
    <table class="min-w-full divide-y divide-gray-200">
      <thead class="bg-gray-50">
        <tr>
          <th
            scope="col"
            class="sticky top-0 z-10 items-center border-b border-gray-300 bg-gray-50 bg-opacity-75 px-2 py-1 text-center text-xs font-medium tracking-wider text-gray-500 backdrop-blur backdrop-filter">
          ...
          <th
            ...
            <input value="search" v-model="query" />
          </th>
        </tr>
      </thead>
          ...
          <template v-for="(network, indexN) in networks" :key="network">
            <tr
                    ...
                    <div
                      ...
                      <div class="rounded-full bg-white p-0">
                        <img
                          ...
                          :src="
                            creator[`${network}_meta`].profile_pic_url ??
                  ...
                  <input
                    ...
                    @blur="
                      $emit('updateCreator', {
                        ...
                        value: creator.crm_record_by_user[`${network}_offer`],
                      })
                    "
                    autocomplete="off"
                    type="creator-offer"
              ...
              <td
                ...
                <div class="justify-right grid grid-cols-2 items-center gap-4">
                  <div>
                    <router-link
                      :to="{
                        name: 'Creator Overview',
                        ...
                        <div class="py-1">
                          <MenuItem
                            ...
                            @click="
                              $emit('updateCreator', {
                                ...
                                value: !creator.crm_record_by_user.muted,
                              })
                            ">
                            <a
                              href="#"
                          ...
                          <MenuItem
                            ...
                            <a
                              ...
                              <ArchiveIcon class="mr-2 inline h-4 w-4" />
                              {{
                                creator.crm_record_by_user[
                                  `${network}_archived`
                                ]
