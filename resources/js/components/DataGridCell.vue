<template>
  <td
    class="isolate border-collapse items-center overflow-auto whitespace-nowrap border text-center text-xs font-medium text-slate-600 dark:border-jovieDark-border dark:text-jovieDark-200"
    ref="cell_area"
    :class="[
