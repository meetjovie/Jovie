...
class AddTwitchFieldsInCreatorsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::table('creators', function (Blueprint $table) {
            ...
            $table->string('twitch_broadcaster_type')->nullable()->index()->after('twitch_category');
            $table->string('twitch_biography')->nullable()->index()->after('twitch_broadcaster_type');
